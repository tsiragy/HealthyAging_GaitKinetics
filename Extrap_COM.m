...
pCOM_ML = pCOM(:,2); %Center of Mass ML direction
pCOM_AP = pCOM(:,1); %Center of Mass AP direction
pCOM_V = pCOM(:,3); %Center of Mass V direction

vCOM_ML = vCOM(:,2); %Center of Mass velocity in ML direction
vCOM_AP = vCOM(:,1); %Center of Mass velocity in AP direction 
